#!/usr/bin/env python3
"""
Comprehensive Batched Matrix Multiplication Benchmark

This script benchmarks batched matrix multiplications with:
- Accuracy comparison (Python vLUT vs PyTorch vs CUDA)
- Timing profiling (with and without encoding time)
- Memory usage profiling
- Multiple matrix sizes and batch sizes
...
class BatchedBenchmark:
    """Comprehensive benchmark for batched matrix multiplications"""
    ...
    def __init__(self):
        ...
        print(f"Initialized Batched Benchmark:")
    ...
    def cuda_batched_matmul(self, A, B):
        """CUDA batched matrix multiplication"""
    ...
    def run_benchmark(self, batch_size, m, k, n, num_runs=3):
        ...
        # 4. CUDA Batched Matrix Multiplication
        print("\n🔬 CUDA Batched Matrix Multiplication...")
        cuda_times = []
        cuda_memories = []
        cuda_results = []
        ...
        for run in range(num_runs):
            result, time_taken, memory_used = self.cuda_batched_matmul(A, B)
    ...
    def run_comprehensive_benchmark(self):
        ...
        print("🚀 Comprehensive Batched Matrix Multiplication Benchmark")
        print("=" * 70)
        ...
        test_configs = [
            ...
            (4, 32, 64, 32),    # Medium batch, large matrices
            (2, 64, 128, 64),   # Small batch, very large matrices
        ]
